...
Next.js app for [rezme.ai](https://rezme.ai) — fullstack using:
...
- **`NEXT_PUBLIC_APP_URL`**: public app URL (local: `http://localhost:3000`; production: `https://rezme.ai`) — used for Stripe redirects; falls back to `BETTER_AUTH_URL` / `AUTH_URL` if unset
